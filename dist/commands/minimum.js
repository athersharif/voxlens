...
var _DefaultExportValue = function _DefaultExportValue(data, options) {
  var values = _get__("getIndependentValues")(data, _get__("min"));
  return {
    key: values[1],
    value: values[0],
    sentence: _get__("generateSentence")('Minimum', "".concat(_get__("addThousandsSeparators")(values[0]), " belonging to ").concat(values[1]), options)
  };
};
