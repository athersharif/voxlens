...
var _DefaultExportValue = {
  filterDataByRegion: _get__("filterDataByRegion"),
  getMatchingRegions: _get__("getMatchingRegions")
};
...
function _get_original__(variableName) {
  switch (variableName) {
    case "filterDataByRegion":
      return filterDataByRegion;

    case "getMatchingRegions":
