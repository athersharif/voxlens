...
var setup = function setup(viewportElement, data) {
  return {
    data: data,
...
var _typeOfOriginalExport = _typeof(setup);
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && Object.isExtensible(setup)) {
